...
{
	//2021-11-16 WSB: remove this ctor later when no longer needed by assimp code
	DirectionalLight(const Vector3& md, const Vector3& mDiff, const Vector3& mSpec) : mDirection(md), mDiffuseColor(mDiff), mSpecColor(mSpec) {}
	DirectionalLight() {}
	// Direction of light
	Vector3 mDirection;
	// Diffuse color
